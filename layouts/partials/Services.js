    ...
    return (
        ...
        <section id="features" className="mx-auto px-4 space-y-6 bg-slate-50 py-8 md:py-12 lg:py-20">
            ...
            <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                {/* Changed from class to className */}
                <h2 className="font-bold text-3xl leading-[1.1] sm:text-3xl md:text-6xl">Offering Services</h2>
                {/* Changed from class to className */}
            ...
            <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
                ...
                {/* Each card needs class replaced with className */}
                {/* For brevity, showing just the first card as example */}
